...
This will do all the timing work for you allowing you to focus on the game.
...
 
Each “setup” has their own base score, and additional points that can be awarded. 
